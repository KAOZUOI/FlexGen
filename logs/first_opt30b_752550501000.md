```bash
(flexgen) jupyter-yyk@node2:~/FlexGen$ python3 -m flexgen.flex_opt --model facebook/opt-30b --percent 75 25 50 50 100 0
...
prefill latency: 2.907 s        prefill throughput: 704.408 token/s
decode latency: 68.487 s        decode throughput: 1.811 token/s
total latency: 71.395 s total throughput: 1.793 token/s
```