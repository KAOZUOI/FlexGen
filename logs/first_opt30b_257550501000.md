```bash
(flexgen) jupyter-yyk@node2:~/FlexGen$ python3 -m flexgen.flex_opt --model facebook/opt-30b --percent 25 75 50 50 100 0
...
TorchDevice: cuda:4
  cur_mem: 4.6329 GB,  peak_mem: 7.7916 GB
TorchDevice: cpu
  cur_mem: 51.8782 GB,  peak_mem: 0.0000 GB
model size: 55.803 GB   cache size: 2.789 GB    hidden size (p): 0.029 GB
peak gpu mem: 7.792 GB  projected: False
prefill latency: 6.184 s        prefill throughput: 331.185 token/s
decode latency: 146.070 s       decode throughput: 0.849 token/s
total latency: 152.253 s        total throughput: 0.841 token/s
```