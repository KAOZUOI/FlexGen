```bash
(flexgen) jupyter-yyk@node2:~/FlexGen$ python3 -m flexgen.flex_opt --model facebook/opt-30b --percent 65 35 50 50 100 0
...
TorchDevice: cuda:4
  cur_mem: 33.5430 GB,  peak_mem: 35.8796 GB
TorchDevice: cpu
  cur_mem: 22.9694 GB,  peak_mem: 0.0000 GB
model size: 55.803 GB   cache size: 2.789 GB    hidden size (p): 0.029 GB
peak gpu mem: 35.880 GB projected: False
prefill latency: 2.981 s        prefill throughput: 687.070 token/s
decode latency: 68.602 s        decode throughput: 1.808 token/s
total latency: 71.582 s total throughput: 1.788 token/s
```