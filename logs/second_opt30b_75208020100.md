```bash
(flexgen) jupyter-yyk@node2:~/FlexGen/test$ python3 -m flexgen.flex_opt --model facebook/opt-30b --percent 75 
20 80 20 100 0
...
TorchDevice: cuda:4
  cur_mem: 33.5431 GB,  peak_mem: 36.5756 GB
TorchDevice: cpu
  cur_mem: 22.9694 GB,  peak_mem: 0.0000 GB
model size: 55.803 GB   cache size: 2.789 GB    hidden size (p): 0.029 GB
peak gpu mem: 36.576 GB projected: False
prefill latency: 3.076 s        prefill throughput: 665.879 token/s
decode latency: 66.444 s        decode throughput: 1.866 token/s
total latency: 69.520 s total throughput: 1.841 token/s
```